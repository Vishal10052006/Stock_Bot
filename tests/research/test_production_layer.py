...
def test_dataset_builder_is_point_in_time():
    ...
    row = ResearchDatasetBuilder().build_row(
        ...
        documents=(doc(minutes=0), doc(minutes=10)),
...
def test_metrics_include_required_outputs():
    ...
    probs = [
        ...
        {"LONG_SUCCESS": 0.1, "SHORT_SUCCESS": 0.2, "NO_EDGE": 0.7},
...
def test_entity_master(tmp_path):
    path = tmp_path / "stockbot-entities.csv"
    path.write_text(

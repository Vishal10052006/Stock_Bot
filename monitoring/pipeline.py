...
class MonitoringPipeline:
    ...
    def __init__(self, engine: MonitoringEngine | None = None, policy: MonitoringPolicy | None = None):
    ...
    def evaluate_model(self, snapshot: ModelMonitoringSnapshot) -> None:
        ...
        for code in alerts:
            severity = AlertSeverity.CRITICAL if "EXCEEDED" in code else AlertSeverity.WARNING
            self.engine.emit_alert(code=code, severity=severity, message=code, component="model")
    ...
    def evaluate_risk(self, snapshot: RiskMonitoringSnapshot) -> None:
        ...
        for code in breaches:
            self.engine.emit_alert(code=code, severity=AlertSeverity.CRITICAL, message=code, component="risk")
    ...
    def evaluate_execution(self, snapshot: ExecutionMonitoringSnapshot) -> None:
        ...
        for code in alerts:
            self.engine.emit_alert(code=code, severity=AlertSeverity.WARNING, message=code, component="execution")
